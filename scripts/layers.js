...
var sources = {
    powerTower: new ol.source.Vector({
        ...
        url: function(extent) {
            return 'geoserver/aws/BGI/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=BGI:powertower&outputFormat=application%2Fjson&srsname=EPSG:3857&bbox=' + extent.join(',') + ',EPSG:3857';
        },
    ...
    powerLines: new ol.source.Vector({
        format: new ol.format.GeoJSON(),
        url: function(extent) {
            return 'geoserver/aws/BGI/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=BGI:powerlines&outputFormat=application%2Fjson&srsname=EPSG:3857&bbox=' + extent.join(',') + ',EPSG:3857';
        },
        strategy: ol.loadingstrategy.bbox
    }),
    solarPolygon: new ol.source.Vector({
        format: new ol.format.GeoJSON(),
        url: function(extent) {
            return 'geoserver/aws/BGI/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=BGI:solarpolygon&outputFormat=application%2Fjson&srsname=EPSG:3857&bbox=' + extent.join(',') + ',EPSG:3857';
        },
        strategy: ol.loadingstrategy.bbox
    })
};
